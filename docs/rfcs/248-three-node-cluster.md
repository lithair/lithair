...
| 2. Three-node consensus | Authenticated multi-host transport, bootstrap, membership/recovery, snapshots and real-process election/partition tests with a test state machine |
