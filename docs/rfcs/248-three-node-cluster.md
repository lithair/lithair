...
| 3. Native integration | [#275](https://github.com/lithair/lithair/issues/275): ordered native writes, retained results, consistent reads and generated routes; [experimental runtime contract and limits](../features/state-engine/native-cluster.md), restart and old-leader return tests |
