...
| `engine::StateEngine`, `engine::RaftstoneApplication`, `Lithair<A>` | The low-level application entry point (below the `LithairServer` builder). Documented, but most apps should prefer `LithairServer`. |
