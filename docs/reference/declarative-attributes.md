...
| `retention = N` | N days retention | `#[lifecycle(retention = 365)]` | Auto-delete after 1 year |
...
pub struct Article {
    ...
    pub content: String,                   // + Deleted after 90d
...
pub struct UserProfile {
    ...
    pub sensitive_data: String,            // Combined policies
}
```
...
| `write = "Perm"` | Write permission | `#[permission(write = "UserWrite")]` | Check before writing |
...
pub struct Article {
    ...
    pub title: String,                     // + Different permissions

    #[rbac(owner_field)]                  // Only the author
    #[permission(write = "ArticleEditOwn")]
    pub content: String,

    #[permission(write = "AdminOnly")]    // Admins only
    pub featured: bool,
...
pub struct HighFrequencyEvent {
    ...
    #[lifecycle(retention = 1)]           // 1 day only
...
- API `/resource/{id}/history` for viewing
- Cleanup task after 365 days
