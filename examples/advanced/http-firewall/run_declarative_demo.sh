...
# Fully declarative firewall demo runner for http-firewall-declarative
...
start_node() {
  ...
  RUST_LOG=${RUST_LOG:-warn} cargo run --release -p http-firewall --bin http-firewall-declarative -- \
...
main() {
  ...
  cargo build --release -p http-firewall --bin http-firewall-declarative >/dev/null
