...
async fn main() -> Result<()> {
    ...
    println!("   ✅ Declarative RBAC with field-level permissions");
    println!("   ✅ Multi-provider SSO (Google, GitHub, Microsoft, JWT)");
    println!("   ✅ Custom middleware (admin password, IP whitelist)");
    println!("   ✅ Role-based data filtering");
    println!();
    println!("👥 Demo Users:");
    println!("   • customer@example.com (Customer role)");
    println!("   • manager@example.com  (ProductManager role)");
    println!("   • admin@example.com    (Administrator role)");
    println!();
    ...
    println!();
    println!("🛡️  Admin (requires extra password):");
    ...
    println!();
    println!("🚀 Starting DeclarativeServer with RBAC...");
    println!();
