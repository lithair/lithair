...
export RS_EVENT_MAX_BATCH=${RS_EVENT_MAX_BATCH:-65536}
export RS_FLUSH_INTERVAL_MS=${RS_FLUSH_INTERVAL_MS:-5}
export RS_FSYNC_ON_APPEND=${RS_FSYNC_ON_APPEND:-0}
...
case "$STORAGE_PROFILE" in
  high_throughput)
    ...
    export RS_ENABLE_BINARY=${RS_ENABLE_BINARY:-1}
    export RS_DISABLE_INDEX=${RS_DISABLE_INDEX:-1}
    export RS_DEDUP_PERSIST=${RS_DEDUP_PERSIST:-0}
    export RS_BUFFER_SIZE=${RS_BUFFER_SIZE:-8388608}
    export RS_MAX_EVENTS_BUFFER=${RS_MAX_EVENTS_BUFFER:-10000}
    export RS_FLUSH_INTERVAL_MS=${RS_FLUSH_INTERVAL_MS:-2}
    export RS_EVENT_MAX_BATCH=${RS_EVENT_MAX_BATCH:-10000}
    export RS_FSYNC_ON_APPEND=${RS_FSYNC_ON_APPEND:-0}
    export RS_SNAPSHOT_EVERY=${RS_SNAPSHOT_EVERY:-10000000}
    ;;
  balanced)
    export RS_OPT_PERSIST=1
    export RS_ENABLE_BINARY=${RS_ENABLE_BINARY:-1}
    export RS_DISABLE_INDEX=${RS_DISABLE_INDEX:-0}
    export RS_DEDUP_PERSIST=${RS_DEDUP_PERSIST:-1}
    export RS_BUFFER_SIZE=${RS_BUFFER_SIZE:-2097152}
    export RS_MAX_EVENTS_BUFFER=${RS_MAX_EVENTS_BUFFER:-2000}
    export RS_FLUSH_INTERVAL_MS=${RS_FLUSH_INTERVAL_MS:-5}
    export RS_EVENT_MAX_BATCH=${RS_EVENT_MAX_BATCH:-2000}
    export RS_FSYNC_ON_APPEND=${RS_FSYNC_ON_APPEND:-0}
    export RS_SNAPSHOT_EVERY=${RS_SNAPSHOT_EVERY:-500000}
    ;;
  durable_security)
    export RS_OPT_PERSIST=1
    export RS_ENABLE_BINARY=${RS_ENABLE_BINARY:-0}
    export RS_DISABLE_INDEX=${RS_DISABLE_INDEX:-0}
    export RS_DEDUP_PERSIST=${RS_DEDUP_PERSIST:-1}
    export RS_BUFFER_SIZE=${RS_BUFFER_SIZE:-1048576}
    export RS_MAX_EVENTS_BUFFER=${RS_MAX_EVENTS_BUFFER:-1000}
    export RS_FLUSH_INTERVAL_MS=${RS_FLUSH_INTERVAL_MS:-10}
    export RS_EVENT_MAX_BATCH=${RS_EVENT_MAX_BATCH:-1000}
    export RS_FSYNC_ON_APPEND=${RS_FSYNC_ON_APPEND:-1}
    export RS_SNAPSHOT_EVERY=${RS_SNAPSHOT_EVERY:-100000}
    ;;
  *)
...
echo "EventStore tuning: RS_EVENT_MAX_BATCH=$RS_EVENT_MAX_BATCH, RS_FLUSH_INTERVAL_MS=${RS_FLUSH_INTERVAL_MS}ms, RS_FSYNC_ON_APPEND=$RS_FSYNC_ON_APPEND"
echo "Optimized persistence: RS_OPT_PERSIST=${RS_OPT_PERSIST:-unset}, RS_ENABLE_BINARY=${RS_ENABLE_BINARY:-unset}, RS_DISABLE_INDEX=${RS_DISABLE_INDEX:-unset}, RS_DEDUP_PERSIST=${RS_DEDUP_PERSIST:-unset}"
echo "Buffers: RS_BUFFER_SIZE=${RS_BUFFER_SIZE:-unset}, RS_MAX_EVENTS_BUFFER=${RS_MAX_EVENTS_BUFFER:-unset}, RS_SNAPSHOT_EVERY=${RS_SNAPSHOT_EVERY:-unset}"
...
EXPERIMENT_DATA_BASE=${EXPERIMENT_DATA_BASE:-examples/raft_replication_demo/data}
