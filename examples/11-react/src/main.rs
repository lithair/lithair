...
//!
//! Same CRUD backend as 03-rest-api, served with a Vite + React frontend.
//! Demonstrates: `npm run build` → `dist/` → `with_frontend()` → SCC2 memory.
//!
//! ## Run
//! ```bash
//! # 1. Build the frontend
//! cd examples/11-react/frontend && npm install && npm run build
//!
//! # 2. Start the server
//! cargo run -p notes-react
//! ```
//!
//! ## Dev (with hot reload)
//! ```bash
...
//! cd examples/11-react/frontend && npm run dev
//! ```
...
async fn main() -> Result<()> {
    ...
    LithairServer::new()
        ...
        .with_frontend("examples/11-react/frontend/dist")
        .serve()
        .await?;
